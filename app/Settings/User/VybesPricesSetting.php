...
use App\Settings\User\Interfaces\VybePricesSettingInterface;

/**
 * Class VybesPricesSetting
 *
 * @package App\Settings\User
 */
class VybesPricesSetting extends UserSetting implements VybePricesSettingInterface
{
    /**
     * Setting name
     *
     * @var string
     */
    protected string $name = 'Vybe prices';
     ...
     * @var string
     */
    protected string $code = 'vybe_prices';
    ...
    ) : array
    {
        return [
            ...
            'children' => [
                [
                    'code'     => 'voice_chat',
                    'name'     => 'Price for voice chat vybes',
                ...
                [
                    'code'     => 'video_chat',
                    'name'     => 'Price for video chat vybes',
                    'children' => array_filter([
                        $this->processField(
                            $customOnly,
                ...
                [
                    'code'     => 'real_life',
                    'name'     => 'Price for real life vybes',
                    'children' => array_filter([
                        $this->processField(
                            $customOnly,
