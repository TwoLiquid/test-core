...
use App\Settings\User\Interfaces\PendingPayoutDelaySettingInterface;

/**
 * Class PendingPayoutDelaySetting
 *
 * @package App\Settings\User
 */
class PendingPayoutDelaySetting extends UserSetting implements PendingPayoutDelaySettingInterface
{
    /**
     * Setting name
     *
     * @var string
     */
    protected string $name = 'Pending payout (Pending balance) delay';
     ...
     * @var string
     */
    protected string $code = 'pending_payout_delay';
