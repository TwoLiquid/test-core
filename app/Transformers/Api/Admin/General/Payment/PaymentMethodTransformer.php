...
use App\Transformers\Api\Admin\General\Payment\Request\PayoutMethodRequestTransformer;
...
class PaymentMethodTransformer extends BaseTransformer
{
    ...
    public function transform(PaymentMethod $paymentMethod) : array
    {
        return [
            ...
            'integrated'      => $paymentMethod->integrated,
            'display_name'    => $paymentMethod->getTranslations('display_name'),
            'duration_title'  => $paymentMethod->getTranslations('duration_title'),
            'duration_amount' => $paymentMethod->getTranslations('duration_amount'),
            'fee_title'       => $paymentMethod->getTranslations('fee_title'),
            'fee_amount'      => $paymentMethod->getTranslations('fee_amount')
        ];
    }
