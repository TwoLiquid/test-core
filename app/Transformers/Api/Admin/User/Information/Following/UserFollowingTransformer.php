...
namespace App\Transformers\Api\Admin\User\Information\Following;
 ...
 *
 * @package App\Transformers\Api\Admin\User\Information\Following
 */
    ...
    public function transform(User $user) : array
    {
        return [
            ...
            'added_at'        => $user->pivot->added_at ?
                Carbon::parse($user->pivot->added_at)->format('Y-m-d\TH:i:s.v\Z') :
                null
        ];
    }
