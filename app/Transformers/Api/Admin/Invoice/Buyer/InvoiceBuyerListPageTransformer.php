...
/**
 * Class InvoiceBuyerListPageTransformer
 *
 * @package App\Transformers\Api\Admin\Invoice\Buyer
 */
class InvoiceBuyerListPageTransformer extends BaseTransformer
{
    /**
    ...
    {
        return $this->item([], new InvoiceBuyerListPageFilterTransformer(
            $this->vybeTypes,
    ...
    {
        return $this->collection($this->buyerInvoices, new InvoiceBuyerListTransformer);
    }
