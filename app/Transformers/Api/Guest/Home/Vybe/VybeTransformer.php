...
use App\Transformers\Api\Guest\Home\Category\Vybe\VybeImageTransformer;
use App\Transformers\Api\Guest\Home\Category\Vybe\VybeVideoTransformer;
use App\Transformers\Api\Guest\Home\Vybe\AppearanceCase\AppearanceCaseTransformer;
use App\Transformers\Api\Guest\Home\Vybe\Schedule\ScheduleTransformer;
...
class VybeTransformer extends BaseTransformer
{
    ...
    public function transform(Vybe $vybe) : array
    {
        ...
        return [
            ...
            'next_id'       => isset($vybe->next_id) ? $vybe->next_id : null,
    ...
    public function includeActivity(Vybe $vybe) : ?Item
    {
        ...
        return $activity ? $this->item($activity, new ActivityShortTransformer) : null;
    }
