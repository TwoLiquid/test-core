...
/**
 * Class VybeChangeRequestAppearanceCaseContainerTransformer
 *
 * @package App\Transformers\Api\General\Vybe\ChangeRequest
 */
class VybeChangeRequestAppearanceCaseContainerTransformer extends BaseTransformer
{
    /**
     * @var Collection
     */
    ...
    public function includeVoiceChat() : ?Item
    {
        ...
        foreach ($this->appearanceCases as $appearanceCase) {
            if ($appearanceCase->getAppearance()->isVoiceChat()) {
                return $this->item($appearanceCase, new VybeChangeRequestAppearanceCaseTransformer);
            }
        }
