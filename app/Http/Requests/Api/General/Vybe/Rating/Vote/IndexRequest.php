...
class IndexRequest extends BaseRequest
{
    ...
    {
        return [
            'paginated.boolean' => trans('validations/api/general/vybe/rating/vote/index.paginated.boolean'),
            'page.integer'      => trans('validations/api/general/vybe/rating/vote/index.page.integer')
        ];
    }
