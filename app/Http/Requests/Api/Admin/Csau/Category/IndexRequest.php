...
class IndexRequest extends BaseRequest
{
    ...
    {
        return [
            'paginated.boolean' => trans('validations/api/admin/csau/category/index.paginated.boolean'),
            'page.integer'      => trans('validations/api/admin/csau/category/index.page.integer')
        ];
    }
