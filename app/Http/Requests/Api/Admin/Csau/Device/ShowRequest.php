...
class ShowRequest extends BaseRequest
{
    ...
    {
        return [
            'paginated.boolean' => trans('validations/api/admin/csau/device/show.paginated.boolean'),
            'page.integer'      => trans('validations/api/admin/csau/device/show.page.integer'),
            'per_page.integer'  => trans('validations/api/admin/csau/device/show.per_page.integer')
        ];
    }
