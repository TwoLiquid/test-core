...
class IndexRequest extends BaseRequest
{
    ...
    {
        return [
            'paginated.boolean' => trans('validations/api/admin/csau/device/index.paginated.boolean'),
            'page.integer'      => trans('validations/api/admin/csau/device/index.page.integer'),
            'per_page.integer'  => trans('validations/api/admin/csau/device/index.per_page.integer')
        ];
    }
