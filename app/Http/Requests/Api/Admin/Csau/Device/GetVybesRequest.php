...
class GetVybesRequest extends BaseRequest
{
    ...
    {
        return [
            'page.integer'     => trans('validations/api/admin/csau/device/getVybes.page.integer'),
            'per_page.integer' => trans('validations/api/admin/csau/device/getVybes.per_page.integer')
        ];
    }
