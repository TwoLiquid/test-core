...
class GetVybesRequest extends BaseRequest
{
    ...
    {
        return [
            'page.integer'     => trans('validations/api/admin/csau/unit/event/getVybes.page.integer'),
            'per_page.integer' => trans('validations/api/admin/csau/unit/event/getVybes.per_page.integer')
        ];
    }
