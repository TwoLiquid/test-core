...
class ShowRequest extends BaseRequest
{
    ...
    {
        return [
            'paginated.boolean' => trans('validations/api/admin/csau/unit/show.paginated.boolean'),
            'page.integer'      => trans('validations/api/admin/csau/unit/show.page.integer'),
            'per_page.integer'  => trans('validations/api/admin/csau/unit/show.per_page.integer')
        ];
    }
