...
class GetVybesRequest extends BaseRequest
{
    ...
    {
        return [
            'page.integer'     => trans('validations/api/admin/csau/platform/getVybes.page.integer'),
            'per_page.integer' => trans('validations/api/admin/csau/platform/getVybes.per_page.integer')
        ];
    }
