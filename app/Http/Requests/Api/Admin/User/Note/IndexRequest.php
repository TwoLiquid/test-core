...
class IndexRequest extends BaseRequest
{
    ...
    {
        return [
            'paginated.boolean' => trans('validations/api/admin/user/note/index.paginated.boolean'),
            'page.integer'      => trans('validations/api/admin/user/note/index.page.integer'),
            'per_page.integer'  => trans('validations/api/admin/user/note/index.per_page.integer')
        ];
    }
