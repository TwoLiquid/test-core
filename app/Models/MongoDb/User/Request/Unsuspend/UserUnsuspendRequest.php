...
namespace App\Models\MongoDb\User\Request\Unsuspend;
...
/**
 * App\Models\MongoDb\User\Request\Unsuspend
 *
 * @property string $_id
 ...
 * @method static Builder|UserUnsuspendRequest find(string $id)
 * @method static Builder|UserUnsuspendRequest query()
 */
class UserUnsuspendRequest extends Model
{
    /**
     ...
     * @var string
     */
    protected $collection = 'user_unsuspend_requests';
    ...
    protected $fillable = [
        ...
        'previous_account_status_id', 'toast_message_type_id', 'toast_message_text',
        'shown', 'request_status_id', 'admin_id', 'language_id'
    ];
