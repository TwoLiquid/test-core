...
namespace App\Models\MongoDb\User\Request\Deletion;
...
/**
 * App\Models\MongoDb\User\Request\Deletion
 *
 * @property string $_id
 ...
 * @method static Builder|UserDeletionRequest find(string $id)
 * @method static Builder|UserDeletionRequest query()
 */
class UserDeletionRequest extends Model
{
     ...
     * @var string
     */
    protected $collection = 'user_deletion_requests';
