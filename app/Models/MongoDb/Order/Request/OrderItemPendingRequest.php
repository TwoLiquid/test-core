...
/**
 * App\Models\MongoDb\Order\Request\OrderItemPendingRequest
 *
 * @property string $_id
 ...
 * @method static Builder|OrderItemPendingRequest find(string $id)
 * @method static Builder|OrderItemPendingRequest query()
 */
class OrderItemPendingRequest extends Model
{
    use HybridRelations;
     ...
     * @var string
     */
    protected $collection = 'order_item_pending_requests';
