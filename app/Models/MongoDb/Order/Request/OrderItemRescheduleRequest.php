...
/**
 * App\Models\MongoDb\Order\Request\OrderItemRescheduleRequest
 *
 * @property string $_id
 ...
 * @method static Builder|OrderItemRescheduleRequest find(string $id)
 * @method static Builder|OrderItemRescheduleRequest query()
 */
class OrderItemRescheduleRequest extends Model
{
    use HybridRelations;
     ...
     * @var string
     */
    protected $collection = 'order_item_reschedule_requests';
    ...
    protected $fillable = [
        ...
        'request_status_id', 'datetime_from', 'datetime_to',
        'from_request_datetime', 'to_request_datetime'
    ];
