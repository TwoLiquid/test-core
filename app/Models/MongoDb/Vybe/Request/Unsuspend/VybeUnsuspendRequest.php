...
namespace App\Models\MongoDb\Vybe\Request\Unsuspend;
...
/**
 * App\Models\MongoDb\Vybe\Request\Unsuspend\VybeUnsuspendRequest
 *
 * @property int $_id
 ...
 * @method static Builder|VybeUnsuspendRequest find(string $id)
 * @method static Builder|VybeUnsuspendRequest query()
 */
class VybeUnsuspendRequest extends Model
{
    /**
     ...
     * @var string
     */
    protected $collection = 'vybe_unsuspend_requests';
