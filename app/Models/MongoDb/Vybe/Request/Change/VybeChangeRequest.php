...
/**
 * App\Models\MongoDb\Vybe\Request\Change\VybeChangeRequest
 *
 * @property int $_id
 ...
 * @method static Builder|VybeChangeRequest find(string $id)
 * @method static Builder|VybeChangeRequest query()
 */
class VybeChangeRequest extends Model
{
    /**
     ...
     * @var string
     */
    protected $collection = 'vybe_change_requests';
    ...
    protected $fillable = [
        ...
        'previous_user_count', 'user_count_status_id', 'type_id', 'previous_type_id',
        'schedules_status_id', 'order_advance', 'previous_order_advance', 'order_advance_status_id', 'images_ids',
        'previous_images_ids', 'videos_ids', 'previous_videos_ids', 'access_id', 'previous_access_id',
        ...
        'status_status_id', 'toast_message_type_id', 'toast_message_text',
        'request_status_id', 'shown', 'admin_id', 'language_id'
    ];
    ...
    protected $casts = [
        'devices_ids'          => 'array',
        'previous_devices_ids' => 'array',
        'images_ids'           => 'array',
        'previous_images_ids'  => 'array',
        'videos_ids'           => 'array',
        'previous_videos_ids'  => 'array',
        'shown'                => 'boolean'
    ];
    ...
    {
        return $this->hasMany(VybeChangeRequestAppearanceCase::class);
    }
    ...
    {
        return $this->hasMany(VybeChangeRequestSchedule::class);
    }
