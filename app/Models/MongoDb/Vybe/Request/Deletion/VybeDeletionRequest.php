...
namespace App\Models\MongoDb\Vybe\Request\Deletion;
...
/**
 * App\Models\MongoDb\Vybe\Request\Deletion\VybeDeletionRequest
 *
 * @property int $_id
 ...
 * @method static Builder|VybeDeletionRequest find(string $id)
 * @method static Builder|VybeDeletionRequest query()
 */
class VybeDeletionRequest extends Model
{
    /**
     ...
     * @var string
     */
    protected $collection = 'vybe_deletion_requests';
