...
<div class="header">
    @if($receipt->getStatus()->isRefunded())
        <div class="title credit">
            <div>Credit add funds receipt</div>
        </div>
    @else
        <div class="title">
            <div>Add funds receipt</div>
        </div>
    @endif
    ...
    @elseif($receipt->getStatus()->isCanceled())
    ...
    <tr>
        ...
        <td class="invoice-heading">
            ...
            @if($receipt->getStatus()->isPaid())
                <p>Payment method</p>
                <p>Payment date</p>
            @elseif($receipt->getStatus()->isRefunded())
                <p>Payment method</p>
                <p>Refunded date</p>
            @elseif($receipt->getStatus()->isUnpaid())
                <p>Payment method</p>
            @endif
        </td>
...
@if($receipt->getStatus()->isRefunded())
    <div class="credit-subtitle">Credit receipt for receipt #{{ $receipt->full_id }}</div>
@endif
...
<table class="items">
    ...
    <tr>
        <td><p class="bold">Add funds</p></td>
...
<table class="transactions-data">
    @foreach($receipt->transactions as $receiptTransaction)
        <tr>
            ...
            <td><p class="bold">{{ $receiptTransaction->external_id }}</p></td>
