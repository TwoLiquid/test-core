...
return new class extends Migration
{
    ...
    {
        Schema::connection('mongodb')->table('order_item_reschedule_requests', function (Blueprint $collection) {
            $collection->id();
            ...
            $collection->dateTime('datetime_from');
            $collection->dateTime('datetime_to');
            $collection->dateTime('from_request_datetime');
            $collection->dateTime('to_request_datetime')->nullable();
