...
return new class extends Migration
{
    ...
    {
        Schema::connection('mongodb')->table('vybe_change_request_appearance_cases', function (Blueprint $collection) {
            $collection->id();
            ...
            $collection->boolean('previous_same_location');
            ...
            $collection->boolean('previous_enabled');
            $collection->integer('enabled_status_id');
